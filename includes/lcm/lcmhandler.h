...
public:
	...
	bool isLcmMessageReceived() const {
		return lcmMessageReceived;
	}

	void setLcmMessageReceived(bool lcmMessageReceived) {
		this->lcmMessageReceived = lcmMessageReceived;
	}
...
private:
	...
	/**
	 * Flag for receiving messages
	 */
	bool lcmMessageReceived;
